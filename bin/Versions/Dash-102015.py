...
def Config_Tab_Dropdown_List():
    ...
    return ['Alert Targets', 'Alert Trigger', 'Action Trigger', 'APC Monitor', 'Counters', 'DashButtons', 'DeviceConfig', 'Dobby Assistant', 'EP Logger', 'gBridge Trigger', 'Log Trigger', 'MQTT Functions', 'Push Trigger', 'Spammer', 'SystemConfig', 'Users']
