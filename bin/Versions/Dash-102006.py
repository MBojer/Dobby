...
def Log_Graph_Tab_Variables(Log_Graph_Dropdown, Log_Graph_Dropdown_Entry, Log_Graph_Slider, Log_Graph_Tab_Variables):
...
def Log_Graph_Tab_Line_Dropdown(Log_Graph_Dropdown, Log_Graph_Tab_Variables):
...
def Log_Graph_Graph(Log_Graph_Tab_Variables):
    ...
    # ======================================== Read Logs ========================================
        ...
        if Log_Graph_Tab_Variables['Log_Graph_Dropdown'] == "APC Monitor":

            for Name in Log_Graph_Tab_Variables['Log_Graph_Dropdown_Entry']:
                for Row in ['Hertz A', 'Hertz B', 'Vin A', 'Vin B', 'I Out', 'IO Max', 'IO Min', 'Active Output']:
                    Data.append(
                        go.Scatter(
        ...
        elif Log_Graph_Tab_Variables['Log_Graph_Dropdown'] == "Log Trigger":
            for Name in Log_Graph_Tab_Variables['Log_Graph_Dropdown']:

                json_Tag_List = SQL_To_List("SELECT DISTINCT json_Tag FROM `" + Log_db.Value[0] + "`.`" + Log_Graph_Tab_Variables['Log_Graph_Dropdown_Entry'].replace(" ", "_") + "` WHERE Name='" + str(Name) + "' AND datetime>'" + str(Log_Graph_Tab_Variables['Slider_Value_Low']) + "' ORDER BY json_Tag;")
                ...
                if len(json_Tag_List) > 1:
                    ...
                    for Tag_Name in json_Tag_List:
                        ...
                        if "Min" in Tag_Name:
                            Data.append(
                                go.Scatter(
                                    x=SQL_To_List("SELECT DateTime FROM `" + Log_db.Value[0] + "`.`" + Log_Graph_Tab_Variables['Log_Graph_Dropdown_Entry'].replace(" ", "_") + "` WHERE Name='" + str(Name) + "' AND json_Tag='" + str(Tag_Name) + "' AND datetime>'" + str(Log_Graph_Tab_Variables['Slider_Value_Low']) + "' ORDER BY id DESC;"),
                                    y=SQL_To_List("SELECT Value FROM `" + Log_db.Value[0] + "`.`" + Log_Graph_Tab_Variables['Log_Graph_Dropdown_Entry'].replace(" ", "_") + "` WHERE Name='" + str(Name) + "' AND json_Tag='" + str(Tag_Name) + "' AND datetime>'" + str(Log_Graph_Tab_Variables['Slider_Value_Low']) + "' ORDER BY id DESC;"),
                    ...
                    Data.append(
                        go.Scatter(
                            x=SQL_To_List("SELECT DateTime FROM `" + Log_db.Value[0] + "`.`" + Log_Graph_Tab_Variables['Log_Graph_Dropdown_Entry'].replace(" ", "_") + "` WHERE Name='" + str(Name) + "' AND datetime>'" + str(Log_Graph_Tab_Variables['Slider_Value_Low']) + "' ORDER BY id DESC;"),
                            y=SQL_To_List("SELECT Value FROM `" + Log_db.Value[0] + "`.`" + Log_Graph_Tab_Variables['Log_Graph_Dropdown_Entry'].replace(" ", "_") + "` WHERE Name='" + str(Name) + "' AND datetime>'" + str(Log_Graph_Tab_Variables['Slider_Value_Low']) + "' ORDER BY id DESC;"),
                            name=str(Name),
                            mode='lines+markers',
                        )
                    )
