...
def Config_Tab_Dropdown_List():
    ...
    return ['Action Trigger', 'APC Monitor', 'DashButtons', 'DeviceConfig', 'Log Trigger', 'Mail Trigger', 'MQTT Functions', 'Spammer', 'SystemConfig', 'Users']
...
@app.callback(
    ...
    [
        ...
        State('Config_Table', 'hs'),
        State('Config_Tab_Variables', 'children'),
        ]
    )
def Config_Tab_Variables(Config_Dropdown, Config_Dropdown_Line, Config_Read, Config_Delete_Row, Config_Save, Config_Table, test, Config_Tab_Variables):
