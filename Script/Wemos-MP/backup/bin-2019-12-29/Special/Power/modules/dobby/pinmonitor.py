...
class Init:
    ...
    def Is_Free(self, Pin):
        ...
        # Pin does HAS an owner
            ...
            if self.Pins[Pin]["Owner"] == 'Indicator':
                self.Dobby.Log(1, "PinMonitor", "Pin: " + Pin + " is owned by Indicator but can be reassigned")
    ...
    def Reserve(self, Pin, Owner, Pull=False, Analog=False):
        ...
        # convert led to pin name if given
        if Pin == "LED":
            Pin = self.LED
        else:
        ...
        if Pin.upper() in self.Pins:
            ...
            # Indicator will be overwriten if set
