...
class Init:
    ...
    def __init__(self, Dobby, Switch_Config):
        ...
        for Name, Config in Switch_Config.items():
            ...
            if self.Peripherals[Name].OK is False:
                ...
                self.Dobby.MQTT_Subscribe(self.Dobby.Peripherals_Topic("Switch", End="+"))
    ...
    def On_Message(self, Payload, Sub_Topic=None):
        ...
        if Topic == self.Dobby.Peripherals_Topic("Switch"):
            ...
            if self.Peripherals.get(Name, None) != None:
                # Switch configured
                ...
                if Command is "?":
                    ...
                    self.Dobby.Log_Peripheral(
                        [
                            ...
                            self.Peripherals[Name].Get_State()
                        ],
                        True
                    )
            else:
