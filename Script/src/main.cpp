...
String MQTT_Topic[MQTT_Topic_Number_Of] = {
  ...
  System_Header + Topic_MPU6050_Text + Hostname,
  System_Header + Topic_BMP180_Text + Hostname
};
...
void Rebuild_MQTT_Topics() {
  ...
  MQTT_Topic[Topic_MPU6050] = System_Header + Topic_MPU6050_Text + Hostname;
  MQTT_Topic[Topic_BMP180] = System_Header + Topic_BMP180_Text + Hostname;
}
...
void MPU6050_Loop() {
  ...
  if ((MPU6050_Interrupt_Status & 0x10) || fifoCount == 16384) {
      ...
      mpu.resetFIFO();
      Log(MQTT_Topic[Topic_Error] + "/MPU6050", "FIFO overflow");
...
void MPU6050_Read_Gyro() {
  ...
  Log(MQTT_Topic[Topic_MPU6050] + "/Gyro/W/State", String(MPU6050_Quaternion.w));
  Log(MQTT_Topic[Topic_MPU6050] + "/Gyro/X/State", String(MPU6050_Quaternion.x));
  Log(MQTT_Topic[Topic_MPU6050] + "/Gyro/Y/State", String(MPU6050_Quaternion.y));
  Log(MQTT_Topic[Topic_MPU6050] + "/Gyro/Z/State", String(MPU6050_Quaternion.z));
